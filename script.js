...
function initLazyGif() {
  // GIFのみを対象にする（価格表モーダルのdata-src画像は対象外）
  const gifs = document.querySelectorAll('.meta-gif-overlay[data-src], .meta-gif-overlay-2[data-src], .meta-gif-overlay-3[data-src]');
